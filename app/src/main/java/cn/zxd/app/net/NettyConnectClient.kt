...
class NettyConnectClient private constructor(val host: String, val tcp_port: Int, val index: Int) {
    ...
    private fun connectServer() {
        ...
        synchronized(this@NettyConnectClient) {
    ...
    class Builder {
        ...
        fun build(): NettyConnectClient {
            val nettyTcpClient = NettyConnectClient(host!!, tcp_port, mIndex)
