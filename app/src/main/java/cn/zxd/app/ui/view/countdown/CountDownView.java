...
public class CountDownView extends View {
    ...
    private static final String TEXT = "30秒返回";
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画居中的文字
//       canvas.drawText(text, width / 2, height / 2 - textPaint.descent() + textPaint.getTextSize() / 2, textPaint);
    ...
    public void start() {
        ...
        countDownTimer = new CountDownTimer(30000, 100) {
            ...
            public void onTick(long millisUntilFinished) {
                progress = ((30000 - millisUntilFinished) / 30000f) * 360;
                invalidate();
            }
